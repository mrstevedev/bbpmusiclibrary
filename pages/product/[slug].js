      ...
      <main className="container">
        ...
        <div className={styles.product__Btm}>
          ...
          <div className="tab-content" id="nav-tabContent">
           ...
           <div className="related__custom" style={{
                 position: 'relative'
           }}>
              <button onClick={handleSlidePrev} className="carousel__control carousel__control--prev" type="button" aria-describedby="carousel-status-s0-0-32-3-0-0[6]-4-match-media-0-ebay-carousel" aria-label="Go to previous slide - Samsung Cell Phones &amp; Smartphones" aria-disabled="true">
              ...
              <button onClick={handleSlideNext} className="carousel__control carousel__control--next" type="button" aria-describedby="carousel-status-s0-0-32-3-0-0[6]-4-match-media-0-ebay-carousel" aria-label="Go to next slide - Samsung Cell Phones &amp; Smartphones" id="s0-0-32-3-0-0[6]-4-match-media-0-ebay-carousel-next">
